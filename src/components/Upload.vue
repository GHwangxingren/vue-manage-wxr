...
<script>
"use strict";
import language from "@/utils/upload/language.js";
import mimes from "@/utils/upload/mimes.js";
import data2blob from "@/utils/upload/data2blob.js";
import effectRipple from "@/utils/upload/effectRipple.js";
...
export default {
  ...
  methods: {
    ...
    upload() {
      let that = this,
        { lang, imgFormat, mime, url, params, headers, field, ki, createImgUrl, withCredentials, method } = this,
        fmData = new FormData();
